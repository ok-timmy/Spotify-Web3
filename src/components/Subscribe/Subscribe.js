  ...
  return (
    ...
    <div className="container grid grid-cols-1 gap-8 px-4 py-12 mx-auto lg:grid-cols-3">
        <div className="flex flex-col items-center max-w-lg mx-auto text-center">
            ...
            <a href="//" className="inline-flex items-center justify-center w-full px-5 py-2 mt-6 text-white bg-blue-600 rounded-lg sm:w-auto hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                Start now
            </a>
        </div>
