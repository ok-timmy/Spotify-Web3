    ...
    it("Check if users have the authority to play an album", async () => {
      ...
      await musicStore
        ...
        .uploadAlbum(
          ...
          // Test for array of published works by a user function
        const worksbyUser1 = await musicStore.getAllAlbums();
        const uxOne = worksbyUser1.filter((x)=> {
          return x.author === user1.address;
        })
        console.log(uxOne, "Works by user 1");
